...
Generation.Legendary = 
  aggregate(pokedex$count, by = list(Generation = pokedex$Generation, Legendary_Pokemon = pokedex$Legendary)
                                 , FUN = sum)
...
Generation.Type1 = aggregate(pokedex$count, by = list(Generation = pokedex$Generation, Type = pokedex$Type.1), 
                             FUN = sum)
